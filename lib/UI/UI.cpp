...
void UI::update() {
  ...
  //control
  if(BtnA.wasPressed()){
    if(panel != MAIN) Lcd.fillRect(0,0,320,218,backgroundColor);
    if(panel == STAT){
  ...
  if(BtnB.wasPressed()){
    if(panel == MAIN){
      ...
      if(m_panel.select == 0b100){ //status
        this->panel = STAT;
      }
      else if(m_panel.select == 0b010){ //control
        this->panel = CONT;
      }
      else{ //settings
        this->panel = SETT;
  ...
  if(BtnC.wasPressed()){
    if(panel == MAIN){
      ...
      if(m_panel.select == 0) this->m_panel.select = 0b100;
    }
    if(panel == CONT){
      this->c_panel.index += 1;
      if(c_panel.index == c_panel.size) this->c_panel.index = 0;
    }
  }
  //main
  if(tick_frame()){
...
void UI::main_panel(){
  ...
  if(m_panel.select != m_panel.lastSel){
    if(m_panel.select & 0b100) Lcd.fillRoundRect(159-135,50,120,120,5,m_panel.selFillColor);
    else Lcd.fillRoundRect(159-135,50,120,120,5,m_panel.fillColor);
    if(m_panel.select & 0b010) Lcd.fillRoundRect(159+15,50,120,120,5,m_panel.selFillColor);
    else Lcd.fillRoundRect(159+15,50,120,120,5,m_panel.fillColor);
    if(m_panel.select & 0b001) Lcd.fillRoundRect(159-75,180,150,30,5,m_panel.selFillColor);
    else Lcd.fillRoundRect(159-75,180,150,30,5,m_panel.fillColor);

    if(m_panel.select & 0b100) Lcd.drawRoundRect(159-135,50,120,120,5,m_panel.selLineColor);
    else Lcd.drawRoundRect(159-135,50,120,120,5,m_panel.lineColor);
    if(m_panel.select & 0b010) Lcd.drawRoundRect(159+15,50,120,120,5,m_panel.selLineColor);
    else Lcd.drawRoundRect(159+15,50,120,120,5,m_panel.lineColor);
    if(m_panel.select & 0b001) Lcd.drawRoundRect(159-75,180,150,30,5,m_panel.selLineColor);
    else Lcd.drawRoundRect(159-75,180,150,30,5,m_panel.lineColor);
...
void UI::menu_disp(){
  ...
  if(m.fillColor != BLACK){
    if(m.leftBtn_visible) Lcd.fillRoundRect(0,219,105,19,5,m.fillColor);    
	  if(m.midBtn_visible) Lcd.fillRoundRect(107,219,105,19,5,m.fillColor);
	  if(m.rightBtn_visible) Lcd.fillRoundRect(214,219,105,19,5,m.fillColor);
  } 
	if(m.leftBtn_visible) Lcd.drawRoundRect(0,219,105,19,5,m.lineColor);
	if(m.midBtn_visible) Lcd.drawRoundRect(107,219,105,19,5,m.lineColor);
	if(m.rightBtn_visible) Lcd.drawRoundRect(214,219,105,19,5,m.lineColor);
  //text
  if(m.leftBtn_visible && m.leftBtn_enable) Lcd.setTextColor(m.lineColor);
  else Lcd.setTextColor(backgroundColor);
  Lcd.setTextSize(2);
  Lcd.setCursor(5,221);
  Lcd.print(m.leftText);

  if(m.midBtn_visible && m.midBtn_enable) Lcd.setTextColor(m.lineColor);
  else Lcd.setTextColor(backgroundColor);
  Lcd.setTextSize(2);
  Lcd.setCursor(112,221);
  Lcd.print(m.midText); 

  if(m.rightBtn_visible && m.rightBtn_enable) Lcd.setTextColor(m.lineColor);
  else Lcd.setTextColor(backgroundColor);
  Lcd.setTextSize(2);
